...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    BroadcastReceiver handActionReceiver = new BroadcastReceiver() {
        @Override
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_play: // 开始播放
                ...
                mPlayThread = new PlayThread(this, "beijing8k16bitsmono.pcm");
                //mPlayThread = new PlayThread(this, "kaluli");
                mPlayThread.start();
                break;
